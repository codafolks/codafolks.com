...
export function EarlyAccessSection() {
  ...
  const [waitlistCount, setWaitlistCount] = useState(171);
    ...
    <div className="relative py-24">
      ...
      >
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-4 text-muted-foreground text-sm">Join {waitlistCount}+ developers already on the waitlist</p>
        </div>
      </motion.div>
    </div>
  );
